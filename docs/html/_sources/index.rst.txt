...
Class diagram can be found at hexagonal.docs.hexagonal-classes.uml. Also a rendered version
:download:`here <_static/hexagonal-classes.pdf>`.

A good starting point would be docs for all models in :ref:`hexagonal.model`.
